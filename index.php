            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="file:///C:/xampp/htdocs/college/index.phpl#">Home</a>
                  </li>
                  <li class="nav-item">
          ...
          <nav class="navbar navbar-dark bg-success">
            <div class="container-fluid">
              <span class="navbar-text">
                <div class="container">
                    <div class="row">
                        <div  class="col col-12 col-sm-3 col-lg-3 col-md-3 col-xl-3 col-xxl-3">
                            <img height="10px" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSBVO7cj9Mlj-9acRkhFWRpTZgC-I8GJe8NUIFTZaesqj2fc64kttutO3cQeksCS12inX8&usqp=CAU" class="img-thumbnail" alt="...">
                        </div>
                        <div class="col col-12 col-sm-9 col-lg-9 col-md-9 col-xl-9 col-xxl-9" ><center><h1>Rajagiri College of Social Science</h1></center></div>
                    </div>
                </div>
              </span>
            </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-secondary">
          <div class="container-fluid">
            <a class="navbar-brand" href="#" style="font-family: Georgia, 'Times New Roman', Times, serif;">NEW UPDATES  : <MARQUEE style="font-family: Georgia, 'Times New Roman', Times, serif; ">
              UG - 2021 Admissions - Applications Open (BCA, BCom, BSc) Happy TEACHERS DAY  </MARQUEE>  </a>
    ...
    <div class="container">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img height="1000px" src="https://rajagiri.edu/uploads/home-banner/5/5.jpg" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img height="1000px" src="https://rajagiri.edu/uploads/departments/3/image.jpg" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img height="1000px" src="https://www.wishill.com/public/uploads/college/default/itemImage_15519456887633.jpg" class="d-block w-100" alt="...">
                  </div>
                </div>
        ...
        <div class="row">
            ...
            <div >
                ...
                <center><img height="30px" src="https://lh3.googleusercontent.com/proxy/4PpaW0OEHzDuXROp09TdXVQb5PROr4AN-5yOd8FbYuUWokyvbs_fJr9TcHx-kvhbp9wwvu-eMo501Cff-aaAkjsCmInYaLWBut1c" class="img-fluid" alt="..."></center>
                <p></p>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="headingTwo">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                 <b> International Conference on "Sustainable Development: Challenges, Opportunities and the Future"
                  Date: 09/Apr/2021 - 10/Apr/2021</b>
              </button>
            </h2>
            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                <strong>About the Conference:</strong> International Conference on “Sustainable Development Challenges, Opportunities and the Future” The International Conference on Sustainable Development, to be organized jointly by Rajagiri Business School, Rajagiri College of Social Sciences (Autonomous) Kochi, India and Western Michigan University, Kalamazoo, USA. ICSD will provide an opportunity to academicians, doctoral students, and practitioners to share and exchange ideas in the area of Sustainable Management. Given the new normal, the participants will have the opportunity to present their paper virtually.
